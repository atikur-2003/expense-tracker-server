...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.vrhjsg7.mongodb.net/?appName=Cluster0`;
      ...
      try {
        ...
        const updateDoc = {
          $set: {
            ...
            icon: updatedIncome.emoji || updatedIncome.icon || "💰",
          },
        };
